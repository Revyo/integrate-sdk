...
<AutoTypeTable path="../src/plugins/types.ts" name="OAuthConfig" />

### MCPPlugin

<AutoTypeTable path="../src/plugins/types.ts" name="MCPPlugin" />
...
<AutoTypeTable path="../src/plugins/github.ts" name="GitHubPluginConfig" />
...
<AutoTypeTable path="../src/plugins/gmail.ts" name="GmailPluginConfig" />
...
<AutoTypeTable
  path="../src/plugins/generic.ts"
  name="GenericOAuthPluginConfig"
/>
...
<AutoTypeTable path="../src/integrations/vercel-ai.ts" name="VercelAITool" />
