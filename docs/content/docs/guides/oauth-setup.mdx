...
When setting up your OAuth apps, use this redirect URI:
...
For production: `https://yourdomain.com/api/integrate/oauth/callback`
...
export const { POST, GET } = toNextJsHandler({
  client: serverClient, // Pass the client from step 2
